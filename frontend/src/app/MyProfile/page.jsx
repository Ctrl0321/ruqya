    ...
    return (
      <div className="p-6 mb-10 min-h-screen">
        <div className="w-full">
          {/* Show default profile with default values */}
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="pt-20 px-8 pb-8">
              ...
              <div className="mt-12 text-center flex flex-col md:flex-row gap-5 justify-center md:space-x-4">
      ...
      <div className="w-full">
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="pt-20 px-8 pb-8">
            ...
            <div className="mt-12 text-center flex flex-col md:flex-row gap-5 justify-center space-x-4">
              <button onClick={handleEditButtonClick} className="inline-flex items-center px-6 py-3 bg-teal-500 hover:bg-teal-600 text-white font-medium rounded-full transition duration-300 shadow-md hover:shadow-lg">
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                </svg>
