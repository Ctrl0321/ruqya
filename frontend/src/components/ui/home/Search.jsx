...
function Search() {
  return (
    <div id="search" className="relative z-20 flex justify-center items-center flex-row md:flex-row px-3 py-2 -mt-5 md:-mt-8 w-auto mx-5 md:mx-auto md:w-2/3 m-auto  bg-white rounded-xl shadow-xl  md:space-y-0 md:space-x-3">
      <div className="flex items-center w-full md:w-3/5 h-full p-1 rounded-lg bg-white">
        {/*<FaSearch size={20} className="fa-thin mr-2 text-gray-500" />*/}
          <SearchNormal1
              ...
              color="#36454F"
          />
          <Input type="text" placeholder="Find Raqi" className="sm:block lg:hidden" />
          <Input type="text" placeholder="Search for Raqis, Ruqyah, or Symptoms" className="hidden lg:block" />
   </div>
      ...
      <Button text="Search" color="RuqyaGreen" bg="true" className={"w-20 md:w-40 md:h-10 bg-RuqyaGreen rounded-lg md:mt-0"} />
      </div>
    </div>
  );
}
