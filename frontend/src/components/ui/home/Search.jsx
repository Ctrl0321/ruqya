...
function Search() {
  return (
    <div id="search" className="relative z-20 flex justify-center items-center flex-row md:flex-row p-3 -mt-5 md:-mt-8 w-auto mx-5 md:mx-auto md:w-2/3 m-auto font-sans bg-white rounded-lg shadow-lg  md:space-y-0 md:space-x-3">
      ...
      <Button text="Search" color="RuqyaGreen" bg="true" className={"w-20 md:w-52 bg-RuqyaGreen  md:mt-0"} />
      </div>
    </div>
  );
}
