...
function Search() {
  return (
    <div id="search" className="relative z-20 flex justify-center items-center flex-col md:flex-row p-3 -mt-5 md:-mt-8 w-auto mx-5 md:mx-auto md:w-2/3 m-auto font-sans bg-white rounded-lg shadow-lg space-y-3 md:space-y-0 md:space-x-3">
