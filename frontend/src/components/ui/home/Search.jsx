...
function Search() {
  ...
  return (
    <div id="search" className="relative z-20 flex justify-center items-center flex-row md:flex-row px-3 py-2 -mt-7 md:-mt-8 w-auto mx-5 md:mx-auto md:w-2/3 m-auto bg-white rounded-xl shadow-xl md:space-y-0 md:space-x-3 font-sans animate-fade-in" style={{ animationDelay: '0.1s' }}>
      <div className="flex items-center justify-center w-full md:w-3/5 h-full p-1 rounded-lg bg-white animate-fade-in" style={{ animationDelay: '0.2s' }}>
        <SearchNormal1 className="fa-thin mr-2 text-gray-500" size="27" color="#36454F" />
      ...
      <div className="md:flex items-center justify-center w-full hidden md:w-1/3 h-full p-1 rounded-lg bg-white animate-fade-in" style={{ animationDelay: '0.4s' }}>
        <Translate className="fa-thin mr-2 text-gray-500" size="27" color="#36454F" />
