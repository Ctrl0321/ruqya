...
function First() {
  return (
    <section id="first" className="relative w-full h-auto bg-RuqyaLightPurple overflow-x-clip">
      ...
      <div className="hidden lg:block absolute lg:right-[-10vw] -top-2 pointer-events-none animate-fade-in animate-spin-slow">
        <svg className="w-[35vw] min-h-[500px] max-h-[65vh] right-0 mr-auto" xmlns="http://www.w3.org/2000/svg" viewBox="8.19 7.39 16.4 18">
