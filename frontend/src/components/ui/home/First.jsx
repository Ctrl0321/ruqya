...
function First() {
  return (
    <section id="first" className="relative w-full h-auto  bg-RuqyaLightPurple overflow-x-clip">
      ...
      <div className="hidden lg:block absolute -right-20 -bottom-3 pointer-events-none animate-fade-in w-full" style={{ animationDelay: "0.2s" }}>
        <svg className="translate-y-20 w-full max-w-[500px] xl:max-w-[500px] 2xl:max-w-[500px] 2xl:max-h-[500px] ml-auto" xmlns="http://www.w3.org/2000/svg" viewBox="8.19 7.39 16.4 18">
...
{/* md:max-w-[65vh]  md:max-h-[65vh] lg:max-h-[65vh] lg:max-w-[65vh] xl:max-h-[69vh] xl:max-w-[69vh] 2xl:max-h-[69vh] 2xl:max-w-[69vh]: 3xl:max-h-[70vh] 3xl:max-w-[70vh]  */}
