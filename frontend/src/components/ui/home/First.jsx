...
function First() {
  return (
    <section id="first" className="relative w-full h-auto bg-RuqyaLightPurple overflow-x-clip">
      ...
      <div className="hidden lg:block absolute -right-10 bottom-2 translate-y-40 pointer-events-none animate-fade-in" style={{ animationDelay: "0.2s" }}>
        <svg className="w-full translate-y-16 ml-auto" xmlns="http://www.w3.org/2000/svg" viewBox="8.19 7.39 16.4 18" style={{ animationDelay: "0.2s", transform: "scale(1.5) translateY(2%)" }}>
