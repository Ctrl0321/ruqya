...
function First() {
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      const newScale = sectionHeight / 300; // Adjust 300 based on the SVG's original height
  ...
  return (
    <section id="first" className="relative w-full h-auto lg:h-60vh bg-RuqyaLightPurple overflow-x-clip">
      ...
      <div className="hidden lg:block absolute right-0 bottom-0 pointer-events-none animate-fade-in" style={{ animationDelay: "0.2s" }}>
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg" viewBox="8.19 7.39 16.4 18" style={{ animationDelay: "0.2s", transform: `scale(${svgScale})` }}>
