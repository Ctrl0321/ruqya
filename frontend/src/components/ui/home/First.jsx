...
function First() {
  return (
    <section id="first" className="relative w-full h-auto bg-gradient-to-l from-[rgba(230,230,250,0.2)] to-RuqyaLightPurple bg-white overflow-x-clip">
      ...
      <div className="hidden lg:block absolute lg:right-[-10vw] -top-0 pointer-events-none animate-fade-in animate-spin-slow">
        <svg className="w-[35vw] min-h-[400px] max-h-[65vh] right-0 mr-auto" xmlns="http://www.w3.org/2000/svg" viewBox="8.19 7.39 16.4 18">
