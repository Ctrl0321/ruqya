...
function First() {
  return (
    <>
      <div id="first" className="flex flex-col items-center justify-center bg-gradient-to-l from-[rgba(230,230,250,0.2)] to-RuqyaLightPurple bg-white min-h-70vh">
        <div className="flex flex-col items-center justify-center md:flex-row mx-5 md:mx-20">
          ...
          <div className="flex flex-col justify-center order-2 min-w-[40vw] md:order-1">
            ...
            <div className="flex flex-row justify-center md:justify-start mb-10 space-x-4">
              <Button text="Book a Session" color="RuqyaGreen" bg={true} className="px-7" />
              <Button text="Learn Ruqah" className="px-7"/>
            </div>
          </div>
        </div>
      </div>
