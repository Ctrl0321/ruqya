...
function First() {
  return (
    <section id="first" className="relative w-full h-auto lg:h-60vh bg-RuqyaLightPurple overflow-x-clip">
      ...
      <div className="hidden lg:block absolute -bottom-[88px] -right-20 pointer-events-none animate-fade-in animate-spin-slow">
        <svg className="h-auto max-h-[700px] min-h-[400px] w-[50vh]" xmlns="http://www.w3.org/2000/svg" viewBox="8.19 7.39 16.4 18">
