...
function Button (props) {
  ...
  return (
    <Link href={disabled ? "#" : link ? link : "#"} className={`pt-3 pb-2 px-4 flex text-center items-center justify-center gap-0 rounded-lg cursor-pointer opacity-100 min-h-10 ${setting} ${className} `}>
