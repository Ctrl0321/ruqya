  ...
  return (
    <div className="relative flex flex-col items-center space-y-4 p-4">
      <div className="relative">
        ...
        >
          <path
            d="M92.0429 52.0116C98.0192 46.0127 108.248 48.733 110.455 56.9081L125.193 111.497C127.4 119.672 119.929 127.171 111.746 124.995L57.1017 110.463C48.9183 108.287 46.1595 98.0681 52.1359 92.0691L92.0429 52.0116Z"
            fill="#FFDF7E"
          />
          <path
            d="M125.79 72.1849C133.973 74.3611 136.732 84.58 130.756 90.5789L90.8486 130.636C84.8722 136.635 74.643 133.915 72.436 125.74L57.6986 71.1508C55.4916 62.9756 62.962 55.477 71.1454 57.6532L125.79 72.1849Z"
            fill="#FFDF7E"
          />
        </svg>
        ...
        <svg width="292" height="328" viewBox="0 0 292 328" fill="none" xmlns="http://www.w3.org/2000/svg" className="relative z-10">
          ...
          <image href={image} x="96" y="14" height="100" width="100" clipPath="url(#clip-circle)" preserveAspectRatio="xMidYMid slice" />
          <path
          ...
          <foreignObject x="0" y="0" width="292" height="328">
            <div className="flex flex-col items-center space-y-4 pt-[100px] font-sans m-5">
              <h2 className="text-xl font-semibold">Dr. Mohammed Maher</h2>
              <div className="w-full space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Country</span>
                  <div className="flex items-center gap-2">
                    <span>Sri Lanka</span>
                    <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-yLpg50ePC8qzY3FgbhbGGFfdM4ZMf7.png" alt="Sri Lanka flag" className="w-5 h-3"/>
                  </div>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex gap-2">
                    ...
                    <span className="px-2 py-1 bg-gray-100 rounded-full text-sm">AR</span>
                    <span className="px-2 py-1 bg-gray-100 rounded-full text-sm">Sin</span>
                  </div>
                </div>
                <div className="flex justify-between items-center">
