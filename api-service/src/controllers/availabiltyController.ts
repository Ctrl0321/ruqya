...
export const getRakiByAvailabilityByDate = async (req: AuthenticatedRequest, res: Response): Promise<any> => {
    try {
        ...
        const rakiIds = availabilityRecords.map((record) => record.rakiId.toString());
